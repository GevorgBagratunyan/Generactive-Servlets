...
public class ItemRepositoryTest {
    ...
    public void create() {
        Item item = new GenerativeItem(14, "TestItem", "generactive.com/items", 112.4, 3, "TWO");
    ...
    public void update() {
        Item item = new GenerativeItem(14, "Updated Item", "generactive.com/items", 888.0, 2, "ONE");
        Optional<Item> updatedOptionalItem = REPOSITORY.update(1, item);
        assertTrue(updatedOptionalItem.isPresent());
        Item updatedItem = updatedOptionalItem.get();
        assertEquals("Updated Item", updatedItem.getName());
        assertEquals(888.0, updatedItem.getBasePrice());
